...
@ApiModel(value="com.example.ygo.entity.Articlecategory")
public class Articlecategory implements Serializable {
    ...
    public static Articlecategory.Builder builder() {
        return new Articlecategory.Builder();
    }

    public static class Builder {
        private Articlecategory obj;

        public Builder() {
            this.obj = new Articlecategory();
        }
