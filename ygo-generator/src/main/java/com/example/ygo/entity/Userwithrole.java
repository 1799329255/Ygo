...
@ApiModel(value="com.example.ygo.entity.Userwithrole")
public class Userwithrole implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        Userwithrole other = (Userwithrole) that;
    ...
    public static Userwithrole.Builder builder() {
        return new Userwithrole.Builder();
    }

    public static class Builder {
        private Userwithrole obj;

        public Builder() {
            this.obj = new Userwithrole();
        }
